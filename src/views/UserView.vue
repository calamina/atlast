  ...
  <main>
    <teleport to="#menu-search">
      <div class="media__search">
        <input type="text" name="search" v-model="search" id="search" placeholder="Search users" autocomplete="off" />
    ...
    <transition name="search" mode="out-in">
      <!-- <ActionOverlay v-if="!!search.length" class="overlay" :component="UserSearch" @exit="search = ''" /> -->
    </transition>
  </main>
</template>
